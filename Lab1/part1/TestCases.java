...
public class TestCases
{
   ...
   public void testSimpleIf3()
   {
     // fail("Missing SimpleIf3");
      /* TO DO: Write one more valid test case. */
       assertEquals(2.0, SimpleIf.max(-1.0, 2.0), DELTA);
   ...
   public void testSimpleLoop3()
   {
     // fail("Missing SimpleLoop3");
      ...
      assertEquals(12, SimpleLoop.sum(3, 5));
   }
   ...
   public void testSimpleArray3()
   {
     // fail("Missing SimpleArray3");
      ...
      assertArrayEquals(
         new int[] {9, 25},
         SimpleArray.squareAll(new int[] {-3, 5}));
   ...
   public void testBetterLoop3()
   {
      ...
      assertFalse(BetterLoop.contains(new int[] {1, 2, 3, 4}, 7));
